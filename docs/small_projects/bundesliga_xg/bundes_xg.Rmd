...
teams.vec <- c('Augsburg', 'Leverkusen', 'Bayern', 'Dortmund', 'Gladbach', "Darmstadt", "Frankfurt", "Hamburg", "Hannover", "Berlin", "Hoffenheim", "Ingolstadt", "Köln", "Mainz", "Schalke", "Stuttgart", "Bremen", "Wolfsburg")
